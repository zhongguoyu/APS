...
var imgHeight = imgWidth/3;

$(".img li img").each(function(){
...
$(".but-left").click(
		function() {
			...
			$(".banner-box .li li").eq(i).addClass('index').siblings()
...
function int() {
	...
	if (i == imgNum - 1) {
		$(".banner-box .li li").eq(0).addClass('index').siblings().removeClass(
				'index');// 给相应的按钮添加样式

	} else {
		$(".banner-box .li li").eq(i).addClass('index').siblings().removeClass(
				'index');// 给相应的按钮添加样式
	}
}